...
# The instruction card drawn at start-up and on every press of the button: a
# picture next to eink_display.py, generated by make_eink_instructions.py.
# Any size works, it is fitted to the screen; drop in your own artwork under
# this name to replace it.
EINK_INSTRUCTIONS_IMAGE = "eink_instructions.png"

# Pictures use the panel's four grey levels (white, light grey, dark grey,
# black); recipes stay black on white. A grey refresh takes a few seconds
# longer than a black-and-white one. False draws pictures dithered in
